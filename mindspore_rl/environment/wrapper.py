...
class Wrapper(Environment):
    ...
    def __init__(self, env: Union[Environment, Sequence[Environment]], params: dict):
        super().__init__()
        self._params = params
        self._env = env
        self._for_property = env if not env.batched else env[0]
    ...
    def action_space(self) -> Space:
        ...
        return self._for_property.action_space
    ...
    def observation_space(self) -> Space:
        ...
        """
        return self._for_property.observation_space
    ...
    def reward_space(self) -> Space:
        ...
        """
        return self._for_property.reward_space
    ...
    def done_space(self) -> Space:
        ...
        """
        return self._for_property.done_space
    ...
    def config(self) -> dict:
        ...
        """
        return self._for_property.config
    ...
    def num_environment(self) -> int:
        ...
        """
        return self._for_property.num_environment
    ...
    def num_agent(self) -> int:
        ...
        """
        return self._for_property.num_agent
    ...
    def _num_reset_out(self) -> int:
        ...
        """
        return getattr(self._for_property, "_num_reset_out")
    ...
    def _num_step_out(self) -> int:
        ...
        """
        return getattr(self._for_property, "_num_step_out")
